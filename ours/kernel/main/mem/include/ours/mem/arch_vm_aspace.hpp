...
namespace ours::mem {
    ...
    class ArchVmAspaceConstraints
        ...
        static_assert(HasFnMap<auto (ArchVmAspace::*)(VirtAddr, PhysAddr, usize, MmuFlags, MapControl, usize *) 
            -> Status>::VALUE,
        "The ArchVmAspace do not implements required method `ArchVmAspace::map`");

        USTL_MPL_CREATE_METHOD_DETECTOR(map_bulk, MapBulk);
        static_assert(HasFnMapBulk<auto (ArchVmAspace::*)(VirtAddr, PhysAddr *, usize, MmuFlags, MapControl, usize *) 
            -> Status>::VALUE,
        "The ArchVmAspace do not implements required method `ArchVmAspace::map_bulk`");
        
        USTL_MPL_CREATE_METHOD_DETECTOR(unmap, Unmap);
        static_assert(HasFnUnmap<auto (ArchVmAspace::*)(VirtAddr, usize, UnmapControl, usize *) -> Status>::VALUE,
