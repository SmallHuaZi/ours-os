...
namespace ours::mem {
    typedef ArchVmAspaceTraits<ArchVmAspace>    ArchAspaceTraits;
    ...
    public:
        ...
        static auto create(VirtAddr base, usize size, VmasFlags flags, char const *, ustl::Rc<VmAspace>) -> ustl::Rc<VmAspace>;
    ...
    protected:
        ...
        VmAspace(VirtAddr, usize, VmasFlags, char const *, ustl::Rc<VmAspace>);
