...
namespace ours::mem {
    ...
    struct AllocContext
    {
        AllocContext(ZoneQueues::IterMut iterator, usize order, Nodbootmemsk nodbootmemsk)
            : order(order),
              nodbootmemsk(nodbootmemsk),
              iterator(iterator)
        {}
    ...
    CXX11_CONSTEXPR
    Nodbootmemsk const DEFAULT_ONLINE_NODE_MASK = {  };
    ...
    auto PmNode::alloc_frame(Gaf flags, usize order, GafPolicy *policy) -> ustl::Result<PmFrame *, Status>
    {}
