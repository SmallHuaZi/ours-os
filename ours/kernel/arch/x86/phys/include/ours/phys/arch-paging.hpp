...
namespace ours::phys {
    typedef arch::paging::PagingDispatcher<arch::paging::X86PagingLevel::PageMapLevel4>::Type   ArchLowerPaging;
    typedef arch::paging::PagingDispatcher<arch::paging::X86PagingLevel::PageMapLevel4>::Type   ArchUpperPaging;
