...
#define X86_MMUF_NOEXECUTABLE       BIT(63) // Active only on x86_64
...
#define X86_KERNEL_HUGE_PAGE_FLAGS \
    (X86_KERNEL_PAGE_FLAGS | X86_MMUF_PAGE_SIZE)

#define X86_MMUF_MASK \
    (X86_MMUF_PRESENT | X86_MMUF_WRITABLE | X86_MMUF_USER | \
     X86_MMUF_WRITE_THROUGH | X86_MMUF_DISCACHE | X86_MMUF_ACCESSED | \
     X86_MMUF_DIRTY | X86_MMUF_PAGE_SIZE | X86_MMUF_GLOBAL | \
     X86_MMUF_NOEXECUTABLE)
...
#define X86_PG_FRAME     ((~(BIT(X86_PAGE_SHIFT)-1)) & (~X86_MMUF_NOEXECUTABLE))
#define X86_PD_FRAME     ((~(BIT(X86_PD_SHIFT)-1)) & (~X86_MMUF_NOEXECUTABLE))
#define X86_PDP_FRAME    ((~(BIT(X86_PDP_SHIFT)-1)) & (~X86_MMUF_NOEXECUTABLE))
