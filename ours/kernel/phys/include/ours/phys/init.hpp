...
namespace ours::phys {
    ...
    static auto global_handoff() -> Handoff * {
        extern Handoff g_handoff;
        return &g_handoff;
    }

    static auto global_aspace() -> Aspace * {
        extern Aspace *g_aspace;
        return g_aspace;
    }
    ...
    /// Once BootMem is initialized, it will set up identity mapping immediately for RAM, provided 
    /// that |aspace| is not NULL.
