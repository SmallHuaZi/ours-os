...
.macro .omi.header.object name, type, len, flags=0, extra=0, align=OMI_HEADER_ALIGNMENT
...
.macro .omi.contaienr.object name, len, flags=0, extra=0, align=OMI_HEADER_ALIGNMENT
    .omi.header.object \name, OMIT_CONTAINER, \len, \flags, \extra, \align
.endm

/// Define a header object which describes kernel information.
.macro .omi.kernel.object name, len, flags=0, extra=0, align=OMI_HEADER_ALIGNMENT
    .omi.header.object \name, OMIT_KERNEL, \len, \flags, \extra, \align
.endm
