...
namespace arch::x86 {
    ...
    struct Desc32
    {
        ...
        alignas(u64) u32 limit_base_lo16;
        u32 flags_base_hi16;

        enum SegmentSystem: u32 {
            SYSTEM = 0,
            NONSYSTEM = 1,
        };
        ...
        constexpr u32 base() const
        {
            return base_lo16() | (base_mid8() << 16) | (base_hi8() << 24);
        }

        constexpr Desc32& set_base(u32 base)
        {
        ...
        constexpr u32 limit() const
        {
            return limit_lo16() | (limit_hi4() << 16);
        }
        constexpr Desc32& set_limit(u32 value)
        {
        ...
        u32 ScaledLimit() const
        {
            return limit() << (granularity() ? 12 : 0);
        }
        constexpr Desc32& SetScaledLimit(u32 value)
        {
    ...
    struct SystemSegmentDesc64
    {
        ...
        // above.
        constexpr u64 base() const
        {
            return (static_cast<u64>(base_63_32()) << 32) | (base_31_24() << 24) |
                   (base_23_16() << 16) | base_15_0();
        }
        constexpr SystemSegmentDesc64& set_base(u64 base)
        {
            return set_base_63_32(static_cast<u32>(base >> 32))
        ...
        constexpr u64 limit() const
        {
            return (limit_19_16() << 16) | limit_15_0();
        }
        constexpr SystemSegmentDesc64& set_limit(u64 limit)
        {
        ...
        // than base and limit.
        constexpr u64 offset() const
        {
            return (static_cast<u64>(offset_63_32()) << 32) | (offset_31_16() << 16) |
                   offset_15_0();
        }
        constexpr SystemSegmentDesc64& set_offset(u64 offset)
        {
            return set_offset_63_32(static_cast<u32>(offset >> 32))
    ...
    struct SegmentSelector
    {
        ...
        static constexpr SegmentSelector FromGdtIndex(u16 index)
        {
    ...
    {
        template <typename T, size_t N> static GdtRegister64 Make(cpp20::span<T, N> entries)
        {
            return {
                .limit = static_cast<u16>(entries.size_bytes() - 1),
    ...
    struct [[gnu::packed]] TaskStateSegment64
    {
        u32 reserved0;
